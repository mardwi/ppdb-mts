...
if (isset($_POST['daftar']) && isset($_POST['setuju']) && $_POST['nama'] != '' && $_POST['mtk'] != ''  && $_POST['bin'] != '' && $_POST['big'] != ''){
    ...
    $urut++;
    $id_baru="MTSN".date('d').sprintf("%05s", $urut);
    //echo $id_baru;
    //akhir buat kode unik//
    ///membuat kunci acak//
    $kunci=password();
    //end//
    ...
    $jurusan2=mysql_real_escape_string($_POST['jurusan2']);
        $jurusan2=htmlspecialchars($jurusan2, ENT_QUOTES);
   ...
   $sql = mysql_query("INSERT INTO biodata_siswa values (NULL, '$id_baru', '$kunci', '$nama', '$jkel', '$tem_lahir', '$tgl', '$bln', '$tahun', '$alamat', '$gol_drh', '$k_pos', '$tinggi', '$berat', '$agama', '$asal_sek', '$alamat_sek', '$thn_lls', '$no_ijazah', '$hp', '$email', '$jurusan1', '$jurusan2', '$bin', '$big', '$ipa', '$mtk', '$ayah', '$ibu', '$wali', '$alamat_wali', '$hp_wali', '$kerja_wali', '$bayar')");
    if ($sql){
...
sambung();
mysql_query("insert into siswa values (NULL,'$id_baru', DEFAULT, DEFAULT, DEFAULT, 1)");
?>
<html>
<head>
